...
java com.sun.tools.javac.Main -d "$check_dir" app/src/main/java/com/doxa/android/LegacyImporter.java app/src/main/java/com/doxa/android/ReaderMigration.java tools/ImporterCheck.java tools/MigrationCheck.java
